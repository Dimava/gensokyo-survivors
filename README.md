...
[![Gensokyo Survivors](readme/preview.png)](https://dimava.github.io/gensokyo-survivors/)
...
| | |
|---|---|
| ![The original prompt](readme/prompt.png) | ![A game by Dimava](readme/dimava.png) |
| ![Claude, Clawd, the numbers and the crew](readme/claude.png) | ![What was Dimava even doing here again?](readme/calls.png) |
| ![Starring Reimu Hakurei](readme/reimu.png) | ![Stage 1, Misty Lake: Cirno and Daiyousei](readme/cirno.png) |

---

This branch holds only the built game (v2.0.0, build of `8641ae6`).
